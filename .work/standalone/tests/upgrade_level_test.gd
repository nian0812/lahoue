...
func _run_tests() -> void:
	...
	var expected_maximums: Dictionary = {
		...
		"cow_barn": 5, "restaurant": 5, "kitchen": 5, "resort": 5,
	}
	...
	_expect(int(world.get("coop_level")) == 1 and int(world.call("get_upgrade_effect", "coop")) == 4, "Coop Lv1 capacity is wrong")
	...
	_expect(int(world.call("get_upgrade_effect", "pig_pen")) == 2, "Pig Pen Lv1 capacity is wrong")
	...
	_expect(int(restaurant.get("kitchen_level")) == 2 and (restaurant.get("tables_by_id") as Dictionary).size() == 4, "Restaurant Lv2 effects are wrong")
	...
	_expect((restaurant.get("tables_by_id") as Dictionary).size() == 15 and int(restaurant.get("kitchen_level")) == 5, "Restaurant/Kitchen maximum effects are wrong")
	...
	_expect(int(world.get_node("restaurant").get("restaurant_level")) == 5, "Restaurant level did not restore")
