...
func _validate_routes_are_unchanged() -> void:
	...
	var truck_expected: Array[Vector2] = [
		Vector2(500, 728), Vector2(620, 750), Vector2(1300, 750), Vector2(1300, 950), Vector2(1920, 950),
	]
...
func _validate_gameplay_coordinates_are_unchanged() -> void:
	...
	_expect((world.get_node("farm/tile_28") as Node2D).position == Vector2(950, 550), "Farm plot #28 has incorrect compact layout")
