...
func _run_tests() -> void:
	...
	_expect((world.get("farm_tiles_by_id") as Dictionary).size() == 28, "world does not contain 28 fixed farm plots")
...
func _validate_data_contract() -> void:
	...
	_expect(data_manager.get_farm_plot_maximum() == 28 and data_manager.get_farm_plot_purchase_cost() == 100000, "farm plot contract is wrong")
	...
	var expected_plot_limits: Dictionary = {1: 3, 5: 5, 10: 8, 15: 12, 20: 16, 25: 20, 30: 25, 35: 28, 40: 28, 45: 28, 50: 28}
	...
	_expect(data_manager.get_restaurant_table_capacity(1) == 2 and data_manager.get_restaurant_table_capacity(5) == 15, "Restaurant table tiers are wrong")
	_expect(data_manager.get_kitchen_cooking_slots(1) == 1 and data_manager.get_kitchen_cooking_slots(5) == 6, "Kitchen tiers are wrong")
